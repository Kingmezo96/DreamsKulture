...
export const products: Product[] = [
  ...
  { id: 10, name: "Let God Carry It Sweatshirt", category: "Sweatshirts", collection: "Sweatshirts", price: 20000, message: "LET GOD CARRY IT", scripture: "Psalm 55:22", tone: "linen", image: "/campaign/let-god-carry-it-blue-shirt.png", sizes: ["M", "L", "XL", "XXL"], colors: ["White", "Black", "Red", "Army Green"] },
  ...
  { id: 12, name: "Cord of Three Couples Tee", category: "Couples", collection: "Couples", price: 22000, message: "CORD OF THREE", scripture: "Ecclesiastes 4:12", tone: "paper", image: "/campaign/couple-connection.png", sizes: ["S", "M", "L", "XL", "XXL"], colors: ["White", "Black", "Green", "Blue", "Yellow", "Maroon", "Coffee Brown", "Chocolate Brown", "Red"] },
  { id: 13, name: "God’s Masterpiece Mug", category: "Gift & Homes", collection: "Gift & Homes", price: 10000, message: "YOU ARE GOD’S MASTERPIECE", scripture: "Ephesians 2:10", tone: "stone", image: "/campaign/gods-masterpiece-mug.png", sizes: ["12 oz"], colors: ["White", "Pink"] },
  { id: 14, name: "Trust in God Throw Pillow", category: "Gift & Homes", collection: "Gift & Homes", price: 25000, message: "TRUST IN GOD", scripture: "Proverbs 3:5", tone: "gift", image: "/campaign/trust-in-god-throw-pillow.png", sizes: ["18 × 18 in"], colors: ["Yellow"] },

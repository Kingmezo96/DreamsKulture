...
export const products: Product[] = [
  ...
  { id: 11, name: "Cross Equals Love Cap", category: "Caps", collection: "Caps", price: 5000, message: "CROSS EQUALS LOVE", scripture: "John 3:16", tone: "ink", image: "/campaign/cross-love-cap.png", badge: "new", sizes: ["Adjustable"], colors: ["Black"] },

      ...
      {checkoutOpen && <div className="overlay" role="dialog" aria-modal="true" aria-label="Checkout">
        ...
        <div className="checkout-modal">
          ...
          <form className="checkout-form" onSubmit={submitCheckout}>
            ...
            <label>Delivery address / pickup note<input name="address" required={shippingOptionId !== "pickup-kubwa"} placeholder={shippingOptionId === "pickup-kubwa" ? "Pickup at No 8 Emmanuel Close, Arab Road, Kubwa" : "Street address"} /></label>
